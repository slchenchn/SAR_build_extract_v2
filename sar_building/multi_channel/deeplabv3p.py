...
img_norm_cfg = dict(
    mean=[0.55328575, 0.55793591, 0.56510989, 0.56561935, 0.55156045, 0.55119922,
          0.55603364, 0.55567665, 0.55726607],
    std=[0.28630793, 0.28915877, 0.290576, 0.29054211, 0.28621222, 0.28613257,
         0.2876105, 0.28735815, 0.28864462],
    to_rgb=False)
train_pipeline = [
...
work_dir = '/data2/ghw/mmseg_workdir/multi_channel/deeplabv3plus_r50-d8_512x512_80k_ade20k'
gpu_ids = range(0, 1)
